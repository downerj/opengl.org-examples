...
main(int argc, char *argv[])
{
    ...
    printf("r - toggle scale/bias effect on the red channel.\n");
    printf("g - toggle scale/bias effect on the green channel.\n");
    printf("b - toggle scale/bias effect on the blue channel.\n");
    printf("s - disable/enable scaling.\n");
    printf("i - disable/enable bias.\n");
    printf("? - view current scale & bias values.\n\n");
    printf("Press <space> to reset all scale & bias parameters.\n");
    printf("Hold the left button and move left/right to scale image values.\n");
    printf("Hold the left button and move up/down to bias image values.\n\n");
