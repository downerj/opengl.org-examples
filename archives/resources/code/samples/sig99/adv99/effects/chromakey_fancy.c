 ...
 * transparent... 
 */
GLfloat lowerfudge = .2f;
GLfloat upperfudge = .8f;
...
void 
change_lower_fudge(int val)
{
    lowerfudge = (float) val / 100.;
    if (upperfudge < lowerfudge)
	upperfudge = lowerfudge;
    draw();
}

void 
change_upper_fudge(int val)
{
    upperfudge = (float) val / 100.;
    if (lowerfudge > upperfudge)
	lowerfudge = upperfudge;
    draw();
}
