...
/* ----------------------------    Top view of plane, middle stretched open  */
 0.2f, 0.f, .98f, -.10f,    0.f,  .02f,/* vertex #'s      4 (.48,0,-.06)            */
 0.f, 0.f, 1.f,   -.36f,  .20f, -.04f,/*                 .                         */
 0.f, 0.f, 1.f,    .36f,  .01f,   0.f,/*                ...                        */
 0.f, 0.f,-1.f,   -.32f,  .02f,   0.f,/*                 .             +X          */
 0.f, 1.f, 0.f,    .48f,   0.f, -.06f,/*               2 . 6,8          ^          */
 0.f, 1.f, 0.f,   -.30f,   0.f, -.12f,/*               . . .            |          */
 0.f,-1.f, 0.f,    .36f, -.01f,   0.f,/*              .. . ..           |          */
 0.f,-1.f, 0.f,   -.32f, -.02f,   0.f,/*               . . .            |          */
 0.f, 0.f,-1.f,    .36f, -.01f,   0.f,/*             . . . . .  +Y<-----*          */
 0.f, 0.f,-1.f,   -.36f, -.20f, -.04f,/*               . . .     for this picture  */
 -0.2f, 0.f, .98f,  -.10f, 0.f,  .02f,/*            .  . . .  .  coord system rot. */
 -0.2f, 0.f, -.98f, -.10f, 0.f,  .02f,/*               . . .     90 degrees        */
 0.f, 0.f, -1.f,  -.36f,  .20f, -.04f,/*           .   . . .   .                   */
 0.f, 0.f, -1.f,   .36f,  .01f,   0.f,/*               . # .           # marks     */
 0.f, 0.f, 1.f,   -.32f,  .02f,   0.f,/*          .    . . .    .   (0,0) origin   */
 0.f, -1.f, 0.f,   .48f,   0.f, -.06f,/*               . . .         (z=0 at top   */
 0.f, -1.f, 0.f,  -.30f,   0.f, -.12f,/*         .     0 . 10    .    of plane)    */
 0.f,1.f, 0.f,     .36f, -.01f,   0.f,/*             . . . . .                     */
 0.f,1.f, 0.f,    -.32f, -.02f,   0.f,/*        .  .   . . .   .  .                */
 0.f, 0.f,1.f,     .36f, -.01f,   0.f,/*         .     . . .     .                 */
 0.f, 0.f,1.f,    -.36f, -.20f, -.04f,/*       1.......3.5.7.......9               */
 0.2f, 0.f, -.98f,  -.10f, 0.f,  .02f,/* (-.36,.2,-.04)                            */
};
...
void init(char *filename) {
    ...
    glAlphaFunc(GL_GREATER, 0.f/255.f);
